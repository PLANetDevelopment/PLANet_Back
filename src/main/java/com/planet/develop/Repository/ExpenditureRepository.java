...
public interface ExpenditureRepository extends JpaRepository<Expenditure, Long> {
     ...
     */
    @Query("select e.user.kakaoEmail, e.cost, ec.eco from Expenditure e " +
            "left join ExpenditureDetail ed on e.eno = ed.eno " +
            "left join Eco ec on e.eno = ec.expenditure.eno " +
     ...
     */
    @Query("select e.user.kakaoEmail, e.cost, ed.exType, e.date from Expenditure e " +
            "left join ExpenditureDetail ed on e.eno = ed.eno " +
     ...
     */
    @Query("select e.user.kakaoEmail, e.cost, ed.exWay, e.date from Expenditure e " +
            "left join ExpenditureDetail ed on e.eno = ed.eno " +
